...
with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/scripts/ea-013-enhanced-scenes.json', 'r') as f:
...
# Navigate to EA-013 and replace scenes
...
# Find and replace
if find_and_replace_scenes(outline, 'EA-013'):
    # Write back the outline
    with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/data/l_outline.json', 'w') as f:
        json.dump(outline, f, indent=2)
    print("✅ Successfully replaced EA-013 scenes with enhanced versions")
else:
    print("❌ Could not find EA-013 in outline")
