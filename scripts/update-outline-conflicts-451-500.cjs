...
console.log('🔄 Updating internal_conflict fields for scenes 451-500...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-451-500-analysis.json'), 'utf8'));
