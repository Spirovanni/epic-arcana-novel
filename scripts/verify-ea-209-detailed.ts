...
async function verifyEA209() {
    console.log('🔍 Verifying EA-209 Import...\n');

    const chapterNumber = 209;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 209 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-209)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-209');
