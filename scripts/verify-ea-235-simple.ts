...
async function verifyEA235() {
    console.log('🔍 Verifying EA-235 Import...\n');

    const chapterNumber = 235;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 235 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-235)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-235');
