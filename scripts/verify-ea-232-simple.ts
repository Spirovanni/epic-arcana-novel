...
async function verifyEA232() {
    console.log('🔍 Verifying EA-232 Import...\n');

    const chapterNumber = 232;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 232 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-232)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-232');
