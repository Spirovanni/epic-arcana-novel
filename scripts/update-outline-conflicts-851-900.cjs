...
console.log('🔄 Updating internal_conflict fields for scenes 851-900...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-851-900-analysis.json'), 'utf8'));
