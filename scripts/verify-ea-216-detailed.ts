...
async function verifyEA216() {
    console.log('🔍 Verifying EA-216 Import...\n');

    const chapterNumber = 216;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 216 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-216)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-216');
