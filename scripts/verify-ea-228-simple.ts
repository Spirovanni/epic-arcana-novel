...
async function verifyEA228() {
    console.log('🔍 Verifying EA-228 Import...\n');

    const chapterNumber = 228;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 228 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-228)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-228');
