...
async function verifyEA214() {
    console.log('🔍 Verifying EA-214 Import...\n');

    const chapterNumber = 214;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 214 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-214)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-214');
