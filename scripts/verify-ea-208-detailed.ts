...
async function verifyEA208() {
    console.log('🔍 Verifying EA-208 Import...\n');

    const chapterNumber = 208;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 208 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-208)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-208');
