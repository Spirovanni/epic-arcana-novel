...
const book3Chapters = book3Data.structure.flatMap(part => part.chapters);
...
function createSimplifiedScenes(chapter) {
...
function updateChapterInOutline(chapterNumber, sourceChapter, outline) {
