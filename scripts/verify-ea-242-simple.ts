...
async function verifyEA242() {
    console.log('🔍 Verifying EA-242 Import...\n');

    const chapterNumber = 242;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 242 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-242)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-242');
