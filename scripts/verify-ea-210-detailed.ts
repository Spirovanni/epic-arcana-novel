...
async function verifyEA210() {
    console.log('🔍 Verifying EA-210 Import...\n');

    const chapterNumber = 210;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 210 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-210)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-210');
