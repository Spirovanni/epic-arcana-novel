...
async function verifyEA212() {
    console.log('🔍 Verifying EA-212 Import...\n');

    const chapterNumber = 212;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 212 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-212)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-212');
