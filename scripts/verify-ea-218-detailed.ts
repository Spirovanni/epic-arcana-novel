...
async function verifyEA218() {
    console.log('🔍 Verifying EA-218 Import...\n');

    const chapterNumber = 218;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 218 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-218)
        ...
        for (const scene of chapterScenes) {
            ...
            // Check the four critical fields
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-218');
