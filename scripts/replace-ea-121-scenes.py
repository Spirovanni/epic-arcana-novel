...
with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/scripts/ea-121-enhanced-scenes.json', 'r') as f:
...
# Navigate to EA-121 and replace scenes
...
# Find and replace
if find_and_replace_scenes(outline, 'EA-121'):
    # Write back the outline
    with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/data/l_outline.json', 'w') as f:
        json.dump(outline, f, indent=2)
    print("✅ Successfully replaced EA-121 scenes with enhanced versions")
else:
    print("❌ Could not find EA-121 in outline")
