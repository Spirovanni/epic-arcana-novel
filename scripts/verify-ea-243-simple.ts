...
async function verifyEA243() {
    console.log('🔍 Verifying EA-243 Import...\n');

    const chapterNumber = 243;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 243 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-243)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-243');
