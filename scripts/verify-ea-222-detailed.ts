...
async function verifyEA222() {
    console.log('🔍 Verifying EA-222 Import...\n');

    const chapterNumber = 222;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 222 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-222)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-222');
