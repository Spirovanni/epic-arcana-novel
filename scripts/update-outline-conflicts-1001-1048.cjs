...
console.log('🔄 Updating internal_conflict fields for scenes 1001-1048...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-1001-1048-analysis.json'), 'utf8'));
