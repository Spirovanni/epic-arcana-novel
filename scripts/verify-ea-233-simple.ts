...
async function verifyEA233() {
    console.log('🔍 Verifying EA-233 Import...\n');

    const chapterNumber = 233;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 233 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-233)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-233');
