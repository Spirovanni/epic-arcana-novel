...
async function verifyEA207() {
    console.log('🔍 Verifying EA-207 Import...\n');

    const chapterNumber = 207;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 207 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-207)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-207');
