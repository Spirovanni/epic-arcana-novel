...
async function main() {
  console.log('🔍 Detailed verification of EA-120 scenes (BOOK 3 FINALE)...\n');

  const [chapter] = await db
    .select()
    .from(chapters)
    .where(eq(chapters.chapterNumber, 120))
    .limit(1);

  if (!chapter) {
    console.log('❌ Chapter 120 not found');
    return;
  }
  ...
  console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
  console.log(`📖 Chapter ${chapter.chapterNumber}: ${chapter.title} 🎬 BOOK 3 FINALE`);
  ...
  console.log('🎬 BOOK 3 COMPLETE - Master of Two Worlds achieved!');
}
