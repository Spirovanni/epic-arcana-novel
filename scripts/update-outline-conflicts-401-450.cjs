...
console.log('🔄 Updating internal_conflict fields for scenes 401-450...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-401-450-analysis.json'), 'utf8'));
