...
async function verifyEA247() {
    console.log('🔍 Verifying EA-247 Import...\n');

    const chapterNumber = 247;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 247 not found');
            return;
        }
        ...
        // Expected scene count (3 for EA-247)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-247');
