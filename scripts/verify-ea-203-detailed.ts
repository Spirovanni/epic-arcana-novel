...
async function verifyEA203() {
    console.log('🔍 Verifying EA-203 Import...\n');

    const chapterNumber = 203;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 203 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-203)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-203');
