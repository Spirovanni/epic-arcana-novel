/**
 * Batch Sync EA-021 to EA-040 Scene Updates to Neon DB
 * 
 * This script iterates through EA-021 to EA-040 in data/l_outline.json
 * and upserts the enhanced scene data into the Neon database.
 * 
 * SCOPE:
 * - Chapters 21 to 40 (Book 1)
 * 
 * Usage: node scripts/sync-ea-021-to-040-scenes.mjs
 */
...
async function syncBatchScenes() {
    try {
        ...
        console.log('\n🎯 Batch Syncing EA-021 to EA-040 scenes to database\n');
