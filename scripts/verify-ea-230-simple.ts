...
async function verifyEA230() {
    console.log('🔍 Verifying EA-230 Import...\n');

    const chapterNumber = 230;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 230 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-230)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-230');
