...
console.log('🔄 Updating internal_conflict fields for scenes 501-550...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-501-550-analysis.json'), 'utf8'));
