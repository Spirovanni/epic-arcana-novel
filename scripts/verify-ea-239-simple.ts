...
async function verifyEA239() {
    console.log('🔍 Verifying EA-239 Import...\n');

    const chapterNumber = 239;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 239 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-239)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-239');
