...
async function verifyEA238() {
    console.log('🔍 Verifying EA-238 Import...\n');

    const chapterNumber = 238;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 238 not found');
            return;
        }
        ...
        // Expected scene count (3 for EA-238)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-238');
