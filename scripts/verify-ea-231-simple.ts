...
async function verifyEA231() {
    console.log('🔍 Verifying EA-231 Import...\n');
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 231 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-231)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-231');
