...
async function verifyEA236() {
    console.log('🔍 Verifying EA-236 Import...\n');

    const chapterNumber = 236;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 236 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-236)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-236');
