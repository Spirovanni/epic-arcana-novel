...
with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/scripts/ea-141-enhanced-scenes.json', 'r') as f:
...
if find_and_replace_scenes(outline, 'EA-141'):
    with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/data/l_outline.json', 'w') as f:
        json.dump(outline, f, indent=2)
    print("✅ Successfully replaced EA-141 scenes")
else:
    print("❌ Could not find EA-141")
