...
/**
 * Check "focus" column format for EA-194 to EA-210
 */

async function main() {
  console.log(`🔍 Checking "focus" column format for EA-194 to EA-210...\n`);
  ...
  for (const chapter of allChapters) {
    ...
    for (const scene of chapterScenes) {
      ...
      console.log(`   Scene ${scene.sceneNumber}: "${focus}"`);
    }
    console.log('');
  }

  console.log('\n📊 Format Analysis:\n');
  console.log('Reference chapters (123-127) show the expected format for the "focus" column.');
