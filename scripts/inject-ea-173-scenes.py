#!/usr/bin/env python3
"""
Safe injection script for EA-173 enhanced scenes into l_outline.json
...
def inject_scenes_for_chapter(outline_path, scenes_path, chapter_id):
    ...
    Args:
        ...
        chapter_id: Chapter identifier (e.g., "EA-173")
    """
    # Load outline
    ...
    # Navigate outline: task_masters > task_master_N > major_task_groups > major_activity_theme_N
    found = False
...
if __name__ == "__main__":
    ...
    scenes_path = project_root / "scripts" / "ea-173-enhanced-scenes.json"
    chapter_id = "EA-173"
    
    print(f"EA-173 Scene Injection Script")
    print(f"=" * 50)
