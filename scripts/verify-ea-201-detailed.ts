...
async function verifyEA201() {
    console.log('🔍 Verifying EA-201 Import...\n');

    const chapterNumber = 201;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 201 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-201)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-201');
