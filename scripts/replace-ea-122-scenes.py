...
with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/scripts/ea-122-enhanced-scenes.json', 'r') as f:
...
# Navigate to EA-122 and replace scenes
...
# Find and replace
if find_and_replace_scenes(outline, 'EA-122'):
    # Write back the outline
    with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/data/l_outline.json', 'w') as f:
        json.dump(outline, f, indent=2)
    print("✅ Successfully replaced EA-122 scenes with enhanced versions")
else:
    print("❌ Could not find EA-122 in outline")
