...
console.log('🔄 Updating internal_conflict fields for scenes 651-700...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-651-700-analysis.json'), 'utf8'));
