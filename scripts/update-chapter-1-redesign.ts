  ...
  try {
    ...
    await db.update(chapters)
      .set({
        ...
        specificTaskGroupDescription: "Francisco's academic despair transforms into cosmic awakening as he discovers the mysterious Trionfi cards for the first time. This opening chapter establishes the emotional and spiritual distance Francisco must travel from ordinary law student to eventual Master of Two Worlds, while introducing the cosmic forces that will shape his destiny.",
        updatedAt: new Date()
      })
