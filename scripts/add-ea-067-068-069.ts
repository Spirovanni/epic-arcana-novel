...
/**
 * Add EA-067, EA-068, and EA-069 chapters from l_outline.json to Neon DB
 * Book 2, Chapters 27, 28, and 29 (all_chapters 67, 68, 69)
 */
...
async function addChapters() {
  console.log('🚀 Adding EA-067, EA-068, and EA-069 to Neon DB...\n');
  ...
  try {
    ...
    const chapterIds = ['EA-067', 'EA-068', 'EA-069'];
    const bookNumber = 2;
