...
async function verifyEA237() {
    console.log('🔍 Verifying EA-237 Import...\n');

    const chapterNumber = 237;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 237 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-237)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-237');
