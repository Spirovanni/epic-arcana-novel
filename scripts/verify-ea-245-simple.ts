...
async function verifyEA245() {
    console.log('🔍 Verifying EA-245 Import...\n');

    const chapterNumber = 245;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 245 not found');
            return;
        }
        ...
        // Expected scene count (3 for EA-245)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-245');
