...
async function verifyEA211() {
    console.log('🔍 Verifying EA-211 Import...\n');

    const chapterNumber = 211;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 211 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-211)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-211');
