...
def main():
    ...
    with open('scripts/ea-149-enhanced-scenes.json', 'r', encoding='utf-8') as f:
    ...
    if not find_and_update(outline, 'EA-149'):
        print("❌ EA-149 not found in outline")
        sys.exit(1)
    ...
    print("✅ EA-149 scenes replaced successfully")
