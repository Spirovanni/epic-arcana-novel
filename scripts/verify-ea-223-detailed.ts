...
async function verifyEA223() {
    console.log('🔍 Verifying EA-223 Import...\n');

    const chapterNumber = 223;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 223 not found');
            return;
        }
        ...
        // Expected scene count (3 for EA-223)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-223');
