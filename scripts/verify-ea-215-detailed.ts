...
async function verifyEA215() {
    console.log('🔍 Verifying EA-215 Import...\n');

    const chapterNumber = 215;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 215 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-215)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-215');
