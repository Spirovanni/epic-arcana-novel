...
async function verifyEA206() {
    console.log('🔍 Verifying EA-206 Import...\n');

    const chapterNumber = 206;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 206 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-206)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-206');
