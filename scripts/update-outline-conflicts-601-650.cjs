...
console.log('🔄 Updating internal_conflict fields for scenes 601-650...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-601-650-analysis.json'), 'utf8'));
