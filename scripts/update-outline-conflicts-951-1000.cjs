...
console.log('🔄 Updating internal_conflict fields for scenes 951-1000...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-951-1000-analysis.json'), 'utf8'));
