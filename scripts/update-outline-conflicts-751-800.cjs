...
console.log('🔄 Updating internal_conflict fields for scenes 751-800...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-751-800-analysis.json'), 'utf8'));
