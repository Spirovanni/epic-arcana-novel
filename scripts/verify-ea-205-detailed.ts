...
async function verifyEA205() {
    console.log('🔍 Verifying EA-205 Import...\n');

    const chapterNumber = 205;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 205 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-205)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-205');
