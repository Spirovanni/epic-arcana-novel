...
async function verifyEA229() {
    console.log('🔍 Verifying EA-229 Import...\n');

    const chapterNumber = 229;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 229 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-229)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-229');
