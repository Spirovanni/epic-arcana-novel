...
def main():
    with open('scripts/ea-151-enhanced-scenes.json', 'r', encoding='utf-8') as f:
    ...
    if not find_and_update(outline, 'EA-151'):
        print("❌ EA-151 not found")
        sys.exit(1)
    
    with open('data/l_outline.json', 'w', encoding='utf-8') as f:
        json.dump(outline, f, indent=2, ensure_ascii=False)
    
    print("✅ EA-151 scenes replaced")
