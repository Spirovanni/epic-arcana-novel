...
console.log('🔄 Updating internal_conflict fields for scenes 701-750...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-701-750-analysis.json'), 'utf8'));
