#!/usr/bin/env python3
"""
Safe injection script for EA-229 enhanced scenes into l_outline.json
...
def inject_scenes_for_chapter(outline_path, scenes_path, chapter_id):
    ...
    Args:
        ...
        chapter_id: Chapter identifier (e.g., "EA-229")
    """
    # Load outline
...
if __name__ == "__main__":
    ...
    scenes_path = project_root / "scripts" / "ea-229-enhanced-scenes.json"
    chapter_id = "EA-229"

    print(f"EA-229 Scene Injection Script")
    print(f"=" * 50)
