...
async function verifyEA213() {
    console.log('🔍 Verifying EA-213 Import...\n');

    const chapterNumber = 213;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 213 not found');
            return;
        }
        ...
        // Expected scene count (3 for EA-213)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-213');
