...
async function verifyEA224() {
    console.log('🔍 Verifying EA-224 Import...\n');

    const chapterNumber = 224;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 224 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-224)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-224');
