#!/usr/bin/env python3
"""
Safe injection script for EA-200 enhanced scenes into l_outline.json
...
def inject_scenes_for_chapter(outline_path, scenes_path, chapter_id):
    ...
    Args:
        ...
        chapter_id: Chapter identifier (e.g., "EA-200")
    """
    # Load outline
...
if __name__ == "__main__":
    ...
    scenes_path = project_root / "scripts" / "ea-200-enhanced-scenes.json"
    chapter_id = "EA-200"

    print(f"EA-200 Scene Injection Script")
    print(f"=" * 50)
