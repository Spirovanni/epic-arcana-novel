...
with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/scripts/ea-021-enhanced-scenes.json', 'r') as f:
...
# Navigate to EA-021 and replace scenes
...
# Find and replace
if find_and_replace_scenes(outline, 'EA-021'):
    # Write back the outline
    with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/data/l_outline.json', 'w') as f:
        json.dump(outline, f, indent=2)
    print("✅ Successfully replaced EA-021 scenes with enhanced versions")
else:
    print("❌ Could not find EA-021 in outline")
