...
console.log('🔄 Updating internal_conflict fields for scenes 801-850...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-801-850-analysis.json'), 'utf8'));
