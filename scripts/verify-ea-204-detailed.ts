...
async function verifyEA204() {
    console.log('🔍 Verifying EA-204 Import...\n');

    const chapterNumber = 204;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 204 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-204)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-204');
