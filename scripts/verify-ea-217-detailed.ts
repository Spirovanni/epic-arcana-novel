...
async function verifyEA217() {
    console.log('🔍 Verifying EA-217 Import...\n');

    const chapterNumber = 217;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 217 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-217)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-217');
