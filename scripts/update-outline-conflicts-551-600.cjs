...
console.log('🔄 Updating internal_conflict fields for scenes 551-600...\n');
const analysis = JSON.parse(fs.readFileSync(path.join(__dirname, 'scenes-551-600-analysis.json'), 'utf8'));
