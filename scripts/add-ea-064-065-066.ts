...
/**
 * Add EA-064, EA-065, and EA-066 chapters from l_outline.json to Neon DB
 * Book 2, Chapters 24, 25, and 26 (all_chapters 64, 65, 66)
 */
...
async function addChapters() {
  console.log('🚀 Adding EA-064, EA-065, and EA-066 to Neon DB...\n');
  ...
  try {
    ...
    const chapterIds = ['EA-064', 'EA-065', 'EA-066'];
    const bookNumber = 2;
    ...
    for (const chapterId of chapterIds) {
      try {
        ...
        const chapterBookNumber = typeof chapterData.novel_book === 'string' 
    ...
    console.log(`   📝 Total processed: ${chapterIds.length}`);
    console.log('\n🎉 All chapters have been added/updated in Neon DB!');
...
addChapters().catch(console.error);
