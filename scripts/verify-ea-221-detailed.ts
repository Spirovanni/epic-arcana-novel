...
async function verifyEA221() {
    console.log('🔍 Verifying EA-221 Import...\n');

    const chapterNumber = 221;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 221 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-221)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-221');
