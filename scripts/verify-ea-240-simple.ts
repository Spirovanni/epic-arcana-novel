...
async function verifyEA240() {
    console.log('🔍 Verifying EA-240 Import...\n');

    const chapterNumber = 240;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 240 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-240)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-240');
