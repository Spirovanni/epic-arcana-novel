...
async function verifyEA202() {
    console.log('🔍 Verifying EA-202 Import...\n');

    const chapterNumber = 202;
    ...
    try {
        ...
        if (!chapter) {
            console.error('❌ Chapter 202 not found');
            return;
        }
        ...
        // Expected scene count (4 for EA-202)
        ...
        console.log('\n' + '='.repeat(50));
        console.log('✅ Verification complete for EA-202');
