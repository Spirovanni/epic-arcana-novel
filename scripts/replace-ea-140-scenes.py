...
with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/scripts/ea-140-enhanced-scenes.json', 'r') as f:
...
# Navigate to EA-140 and replace scenes
...
# Find and replace
if find_and_replace_scenes(outline, 'EA-140'):
    # Write back the outline
    with open('/Users/xaviermartinez/dev/cursor/epic-arcana-novel/data/l_outline.json', 'w') as f:
        json.dump(outline, f, indent=2)
    print("✅ Successfully replaced EA-140 scenes with enhanced versions")
else:
    print("❌ Could not find EA-140 in outline")
