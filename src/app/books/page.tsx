    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {books.map((book) => {
          ...
          const glowColor = backgroundColor + '40';
          ...
          return (
            ...
            >
              <Card className="relative overflow-hidden transition-all duration-500 transform hover:scale-[1.03] hover:rotate-1 h-[360px] group-hover:shadow-2xl border-border/50"
                style={{
                ...
                <CardContent className="p-0 h-full">
                  ...
                  <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                    ...
                    <div className="relative z-20">
                      <Badge 
                        className={`mb-6 ${textColorClass} backdrop-blur-md border group-hover:scale-105 transition-all duration-300`}
                        style={{ 
                    ...
                    <div className="relative z-20 space-y-4">
                      {book.colorTheme && (
                        <Badge 
                          className={`${textColorClass} backdrop-blur-md border group-hover:scale-105 transition-all duration-300`}
                          style={{
                          ...
                          ></div>
                          {book.colorTheme.name.toUpperCase()}
                        </Badge>
                      )}
                    </div>
