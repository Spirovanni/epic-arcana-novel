...
export async function scoreAssessment(
  ...
  const result: AssessmentResult = {
    ...
    profile: personalityMatch ? {
      ...
      rgbHex: personalityMatch.rgbHex || undefined,
      enneagramLink: personalityMatch.enneagramLink || undefined,
      colorAlignment: personalityMatch.colorAlignment || undefined,
      scoringModel: personalityMatch.scoringModel || undefined,
    } : {
      id: ea_id,
