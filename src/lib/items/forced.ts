import { ForcedChoiceItem } from '../assessment/types'
  ...
  },
  {
    ...
    options: [
      ...
      { 
        ...
        keys: { 
          dimensions: { agency: 0.18, emotional_intensity: 0.16, adaptability: 0.14 },
          types: { "4": 0.22, "8": 0.12 }, 
          instincts: { SX: 0.08 } 
        } 
      }
  ...
  },
  {
    ...
    options: [
      ...
      { 
        ...
        keys: { 
          dimensions: { emotional_intensity: 0.20, adaptability: 0.18, stability: 0.14 },
          types: { "4": 0.24, "8": 0.10 }, 
          instincts: { SP: 0.08 } 
        } 
      }
