...
export const users = pgTable('users', {
  ...
  isTrialExpired: boolean('is_trial_expired').default(false).notNull(),
  isTrialStarted: boolean('is_trial_started').default(false).notNull(),
  isTrialEnded: boolean('is_trial_ended').default(false).notNull(),
  credits: integer().default(0).notNull(),
  creditsUsed: integer('credits_used').default(0).notNull(),
  creditsRemaining: integer('credits_remaining').default(0).notNull(),
  creditsExhausted: boolean('credits_exhausted').default(false).notNull(),
  creditsExhaustedAt: timestamp('credits_exhausted_at', { mode: 'string' }),
  creditsExhaustedReason: varchar('credits_exhausted_reason', { length: 255 }).default('').notNull(),
  creditsExhaustedReasonDescription: varchar('credits_exhausted_reason_description', { length: 255 }).default('').notNull(),
