...
export const AssessmentResultSchema = z.object({
  ...
  profile: z.object({
    ...
    rgbHex: z.string().optional(),
    enneagramLink: z.record(z.any()).optional(),
    colorAlignment: z.record(z.any()).optional(),
    scoringModel: z.record(z.any()).optional(),
  }),
