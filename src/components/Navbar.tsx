    ...
    <header className="sticky top-0 z-40 w-full backdrop-blur supports-[backdrop-filter]:bg-[#0b1220]/70 border-b border-white/5">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex h-20 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm text-slate-300 font-semibold">
          <Link href="/books" className="hover:text-white/90 transition-colors tracking-wide">Books</Link>
          <Link href="/characters" className="hover:text-white/90 transition-colors tracking-wide">Characters</Link>
          <Link href="/timelines" className="hover:text-white/90 transition-colors tracking-wide">Timelines</Link>
        ...
        <div className="md:hidden border-t border-white/5 bg-[#0b1220]/95 backdrop-blur">
          <div className="px-4 py-4 space-y-4">
            <nav className="space-y-2">
              <Link href="/books" className="block text-slate-300 hover:text-white/90 transition-colors">Books</Link>
              <Link href="/characters" className="block text-slate-300 hover:text-white/90 transition-colors">Characters</Link>
              <Link href="/timelines" className="block text-slate-300 hover:text-white/90 transition-colors">Timelines</Link>
